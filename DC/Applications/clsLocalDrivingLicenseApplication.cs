...
namespace DC.Applications
{
...

    {
        ...
        public string PersonFullName
        {
            get
            {
                clsPerson tempPerson = clsPerson.FindByPersonID(ApplicantPersonID);
                return tempPerson.FirstName + " " + tempPerson.SecondName + " " + tempPerson.ThirdName + " " + tempPerson.LastName;
            }
