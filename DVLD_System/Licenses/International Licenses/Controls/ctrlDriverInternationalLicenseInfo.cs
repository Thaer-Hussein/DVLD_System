...
namespace DVLD_System.Licenses.International_Licenses.Controls
{
    public partial class ctrlDriverInternationalLicenseInfo : UserControl
    {
        ...
        public void LoadInfo(int InternationalLicenseID)
        {
            ...
            clsPerson temp = _InternationalLicense.DriverInfo.PersonInfo;
            lblFullName.Text = temp.FirstName + temp.SecondName + temp.ThirdName + temp.LastName;
            lblNationalNo.Text = _InternationalLicense.DriverInfo.PersonInfo.NationalNo;
            lblGendor.Text = _InternationalLicense.DriverInfo.PersonInfo.Gender == false ? "Male" : "Female";
            string tempText = _InternationalLicense.DriverInfo.PersonInfo.DateOfBirth?.ToString("dd/MM/yyyy")?? DateTime.MinValue.ToString();
