...
namespace DVLD_System.Applications.License.Release_Detained_License
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblCreatedByUser.Text = clsGeneral_class_infos.User.UserName;
        ...
        private void btnRelease_Click(object sender, EventArgs e)
        {
            ...
            bool IsReleased = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.ReleaseDetainedLicense(clsGeneral_class_infos.User.UserID, ref ApplicationID); ;
