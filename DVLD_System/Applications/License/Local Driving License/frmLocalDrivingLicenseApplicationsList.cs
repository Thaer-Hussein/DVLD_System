...
using DVLD_System.Licenses.Local_Driving_License;
...
namespace DVLD_System.License.Local_Driving_License
{
    public partial class frmLocalDrivingLicenseApplicationsList : Form
    {
        ...
        private void vistionTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmTakeTests frm = new frmTakeTests(Appointment.TestAppointmentID, clsTestType.enTestType.VisionTest);
            frm.ShowDialog();
        }
        ...
        private void writtenTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmTakeTests frm = new frmTakeTests(Appointment.TestAppointmentID, clsTestType.enTestType.WrittenTest);
            frm.ShowDialog();
        }
        ...
        private void streetTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmTakeTests frm = new frmTakeTests(Appointment.TestAppointmentID, clsTestType.enTestType.StreetTest);
            frm.ShowDialog();
