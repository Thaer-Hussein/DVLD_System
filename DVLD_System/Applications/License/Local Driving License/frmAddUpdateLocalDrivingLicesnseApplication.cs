...
namespace DVLD_System.License.Local_Driving_License
{
    public partial class frmAddUpdateLocalDrivingLicesnseApplication : Form
    {
        ...
        public frmAddUpdateLocalDrivingLicesnseApplication()
        {
            InitializeComponent();
            _Mode = enMode.AddNew;
            ctrlPersonCardWithFilter1.FilterEnable();
        }
        ...
        private void _LoadData()
        {
            ...
            ctrlPersonCardWithFilter1.FilterDisable();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _LocalDrivingLicenseApplication.CreatedByUserID = clsGeneral_class_infos.User.UserID;
        ...
        private void frmAddUpdateLocalDrivingLicesnseApplication_LocationChanged(object sender, EventArgs e)
        {
